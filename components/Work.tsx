        ...
        <ScrollReveal width="100%">
          <div className="mb-20 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-6">
               ...
               <span className="text-xs font-bold tracking-widest text-indigo-400 uppercase">Selected Work</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Real results for <br/> ambitious companies.
            </h2>
            <p className="text-lg text-slate-400 leading-relaxed">
               We build products that move the needle. Here are a few recent success stories from our studio.
            </p>
          </div>
        </ScrollReveal>
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <div className="mb-6 bg-slate-950/50 border border-white/5 rounded-xl p-4 flex items-start gap-3 group-hover:border-indigo-500/20 transition-colors">
                    ...
                    <div>
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wide block mb-0.5">Impact</span>
                        <span className="text-sm font-medium text-white">{project.outcome}</span>
                    </div>
                </div>
